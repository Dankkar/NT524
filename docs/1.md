...
Trang thai: tai lieu nay la ban plan/thiet ke ban dau. Phan lon hang muc da duoc trien khai xong; trang thai moi nhat nam trong `README.md`, `docs/task.md`, `docs/devsecops-phases.md` va `docs/feedback-api.md`.

## 1. Muc Tieu

Tai thoi diem lap plan, project moi co site-to-site VPN, AWS WAF node, OpenStack app node va ELK/SIEM. Theo feedback kien truc moi can bo sung cac thanh phan sau:
